...
namespace deviceSim
{
    class Program
    {
        ...
        static string connectionString = "HostName=hhnext.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=JMe05SJJEUX1keRRewjofcMIv5bQjVqLDFZBDjY5/cE=";
